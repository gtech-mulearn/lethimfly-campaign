  ...
  return (
    <div className="container" style={{ paddingTop: 'var(--space-8)', paddingBottom: 'var(--space-16)', maxWidth: '600px' }}>
      ...
      <p className="section-subtitle">
        {campusName
          ? `Committing for ${campusName}`
          : 'Join the #LetHimFly campaign'}
      </p>

      {!campusId && (
        <div className="card" style={{ marginBottom: 'var(--space-6)', padding: 'var(--space-4)', borderColor: 'var(--accent-gold)' }}>
        ...
        <div className="form-group">
          <label className="checkbox-wrapper">
            ...
            <span className="checkbox-label">
              I agree to the campaign terms and verification policy. I understand
